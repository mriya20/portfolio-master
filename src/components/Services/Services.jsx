...
const Services = () => {
    return (
        <section id='services'>
            <h5 data-aos="fade-up" data-aos-anchor="#services" data-aos-duration='700'>You can browse and request services here</h5>
            ...
            <div className="container services__container">
                ...
                <article className="service" data-aos="fade-left" data-aos-anchor=".services__container" data-aos-duration="900">
                    ...
                    <ul className="service__list">
                        ...
                        <li>
                            <BiCheck className='service__list-icon' />
                            <p>Developing and implementing digital marketing strategies including SEO and Google Analytics</p>
                        </li>
                    </ul>
                </article>
